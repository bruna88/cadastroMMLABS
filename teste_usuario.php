...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $Result1 = mysqli_query($conexao,$insertSQL) or die(mysql_error());
}
?>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Nm_usuario:</td>
      <td><input type="text" name="nm_usuario" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
